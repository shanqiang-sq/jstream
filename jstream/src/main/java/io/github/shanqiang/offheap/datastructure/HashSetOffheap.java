...
//    private int threshold = 0;
    ...
    private static final long INSTANCE_SIZE = Serializer.initProperties(HashSetOffheap.class, properties);
    ...
    {
        putLong(table() + position * Long.BYTES, addr);
    }
