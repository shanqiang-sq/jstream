...
//    }
    ...
    void set(long offset, long srcAddr, long srcLength) {
        ...
        InternalUnsafe.copyMemory(srcAddr, addr + offset, srcLength);
    }
    ...
    public void set(long offset, byte[] srcBytes, long srcOffset, long srcLength) {
        ...
        InternalUnsafe.copyMemory(srcBytes, ARRAY_BYTE_BASE_OFFSET + srcOffset, null, addr + offset, srcLength);
    }
    ...
    public byte[] get(long offset, long length) {
        ...
        InternalUnsafe.copyMemory(null, addr + offset, ret, ARRAY_BYTE_BASE_OFFSET, offheap.len);
        return ret;
    }
}